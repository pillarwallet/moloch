...
contract('Moloch', ([creator, summoner, applicant1, applicant2, processor, delegateKey, nonMemberAccount, ...otherAccounts]) => {
  ...
  const fundAndApproveToMoloch = async ({
    ...
    await tokenAlpha.transfer(to, value, {
      from: from
    })
    await tokenAlpha.approve(moloch.address, value, {
      from: to
    })
  }
  ...
  beforeEach(async () => {
    ...
    tokenAlpha.transfer(summoner, initSummonerBalance, {
      from: creator
    })
  })
  ...
  describe('sponsorProposal', () => {
    ...
    it.skip('emits SponsorProposal event', async () => {
      ...
      const emittedLogs = await moloch.sponsorProposal(firstProposalIndex, {
        from: summoner
      })
      const {
        logs
    ...
    describe('with a second member besides the summoner', () => {
      ...
      it('failure - sponsor kick proposal already proposed', async () => {
        ...
        await tokenAlpha.transfer(summoner, deploymentConfig.PROPOSAL_DEPOSIT, {
          from: creator
        })
    ...
    it('failure - proposal has been cancelled', async () => {
      ...
      await moloch.cancelProposal(firstProposalIndex, {
        from: proposer
      })
    ...
    it('require fail - insufficient deposit token', async () => {
      ...
      // SafeMath reverts in ERC20.transferFrom
      await moloch.sponsorProposal(invalidPropsalIndex, {
          from: summoner
        })
        .should.be.rejectedWith(SolRevert)
    })
  ...
  describe('having submitted two whitelist proposals for the same token, with one sponsored...', () => {
    ...
    it('when the first whitelist proposal **passes**, the second can no longer be sponsored', async () => {
      ...
      await moloch.processWhitelistProposal(firstProposalIndex, {
        from: summoner
      })
    ...
    it('when the first whitelist proposal **fails**, the second can still be sponsored', async () => {
      await moloch.submitVote(firstProposalIndex, no, {
        from: summoner
      }) // vote NO
  ...
  describe('submitVote', () => {
    ...
    it('require fail - vote must be less than 3', async () => {
      await moloch.submitVote(firstProposalIndex, 3, {
          from: summoner
        })
    ...
    describe('voting period boundary', () => {
      it('require fail - voting period has expired', async () => {
        ...
        await moloch
          .submitVote(firstProposalIndex, yes, {
            from: summoner
          })
    ...
    it('require fail - vote must be yes or no', async () => {
      ...
      // vote null
      await moloch
        .submitVote(firstProposalIndex, 0, {
          from: summoner
        })
    ...
    it.skip('emits SubmitVote event', async () => {
      await moveForwardPeriods(1)
      const emittedLogs = await moloch.submitVote(0, 1, {
        from: summoner
      })
    ...
    describe('submitVote modifying member.highestIndexYesVote', () => {
      ...
      it('happy case - no vote, highestIndexYesVote not updated', async () => {
        ...
        await moveForwardPeriods(2)
        await moloch.submitVote(secondProposalIndex, no, {
          from: summoner
        })
  ...
  describe('processProposal', () => {
    ...
    it.skip('emits ProcessProposal event', async () => {
      ...
      const emittedLogs = await moloch.processProposal(firstProposalIndex, {
        from: processor
      })
      const {
        logs
    ...
    it('happy path  - applicant is used as a delegate key so delegate key is reset', async () => {
      ...
      await moloch.updateDelegateKey(proposer, {
        from: summoner
      })
    ...
    it('require fail - proposal does not exist', async () => {
      await moloch.processProposal(invalidPropsalIndex, {
          from: processor
        })
    ...
    it('require fail - must be a guild kick proposal', async () => {
      ...
      await moloch.processGuildKickProposal(firstProposalIndex, {
          from: applicant
        })
  ...
  describe('rageQuit', () => {
    ...
    describe('partial shares', () => {
      ...
      beforeEach(async () => {
        ...
        const {
          logs
        } = await moloch.ragequit(partialRageQuitShares, 0, {
          from: proposal1.applicant
        })
        emittedLogs = logs
      })
    ...
    describe('require fail - ', () => {
      ...
      it('requesting more loot than you own', async () => {
        await moloch.ragequit(0, proposal1.lootRequested + 1, {
            from: proposal1.applicant
          })
  ...
  describe('safeRageQuit', () => {
    ...
    describe('happy path - ', () => {
      ...
      beforeEach(async () => {
        const {
          logs
        } = await moloch.safeRagequit(proposal1.sharesRequested, proposal1.lootRequested, [proposal1.tributeToken], {
          from: proposal1.applicant
        })
        emittedLogs = logs
      })
    ...
    describe('partial shares', () => {
      ...
      beforeEach(async () => {
        ...
        const {
          logs
        } = await moloch.safeRagequit(partialRageQuitShares, 0, [proposal1.tributeToken], {
          from: proposal1.applicant
        })
        emittedLogs = logs
      })
    ...
    describe('partial loot', () => {
      it('member shares reduced', async () => {
        ...
        await moloch.safeRagequit(0, partialRageQuitLoot, [proposal1.tributeToken], {
          from: proposal1.applicant
        })
    ...
    describe('require fail - ', () => {
      it('not a member', async () => {
        await moloch.safeRagequit(1, 0, [proposal1.tributeToken], {
            from: nonMemberAccount
          })
      ...
      it('requesting more shares than you own', async () => {
        await moloch.safeRagequit(proposal1.sharesRequested + 1, 0, [proposal1.tributeToken], {
            from: proposal1.applicant
          })
      ...
      it('requesting more loot than you own', async () => {
        await moloch.safeRagequit(0, proposal1.lootRequested + 1, [proposal1.tributeToken], {
            from: proposal1.applicant
          })
      ...
      it('token must be whitelisted', async () => {
        ...
        await moloch.safeRagequit(1, 0, [newToken.address], {
            from: proposal1.applicant
          })
      ...
      it('token list must be in order', async () => {
        ...
        await moloch.processWhitelistProposal(secondProposalIndex, {
          from: summoner
        })

        // correct order
        await moloch.safeRagequit(1, 0, [tokenAlpha.address, newToken.address], {
          from: proposal1.applicant
        })

        // incorrect order
        await moloch.safeRagequit(1, 0, [newToken.address, tokenAlpha.address], {
            from: proposal1.applicant
          })
  ...
  describe('cancelProposal', () => {
    ...
    it.skip('emits CancelProposal event', async () => {
      const emittedLogs = await moloch.cancelProposal(0, {
        from: proposal1.applicant
      })
      const {
        logs
  ...
  describe('updateDelegateKey', () => {
    it('happy case', async () => {
      await moloch.updateDelegateKey(processor, {
        from: summoner
      })
    ...
    it('failure - can not be zero address', async () => {
      await moloch.updateDelegateKey(zeroAddress, {
          from: summoner
        })
    ...
    it('failure - cant overwrite existing members', async () => {
      ...
      await moloch.updateDelegateKey(applicant, {
          from: summoner
        })
  ...
  describe('ragekick & bailout & canBailout - member has never voted', () => {
    beforeEach(async () => {
      ...
      await moveForwardPeriods(deploymentConfig.VOTING_DURATON_IN_PERIODS)
      await moveForwardPeriods(deploymentConfig.GRACE_DURATON_IN_PERIODS)
      await moloch.processGuildKickProposal(secondProposalIndex, {
        from: processor
      })
  ...
  describe('as a member with solely loot and no shares...', () => {
    ...
    it('can still ragequit (justMember modifier)', async () => {
      ...
      await moloch.ragequit(0, lootToRageQuit, {
        from: proposal1.applicant
      })
    ...
    it('unable to update delegateKey (justShareholder modifier)', async () => {
      await moloch.updateDelegateKey(applicant2, {
          from: proposal1.applicant
        })
