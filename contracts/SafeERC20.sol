...
library SafeERC20 {
    ...
    */
    function staticBalanceOf(IERC20 _token, address _owner) internal view returns (uint256) {
    ...
    * Reverts if the call fails for some reason (should never fail).
    */
    function staticAllowance(IERC20 _token, address _owner, address _spender) internal view returns (uint256) {
    ...
    * Reverts if the call fails for some reason (should never fail).
    */
    function staticTotalSupply(IERC20 _token) internal view returns (uint256) {
